...
from docker2ansible.exception import ConvertException
...
DIRECTIVE_PROCESSING = {cmd: getattr(docker2ansible.phase_1.process_directive, 'process_' + cmd)
                        for cmd in VALID_DIRECTIVES}
