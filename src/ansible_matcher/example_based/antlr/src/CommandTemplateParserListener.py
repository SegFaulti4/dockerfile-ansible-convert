...
class CommandTemplateParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CommandTemplateParser#template_object.
    def enterTemplate_object(self, ctx:CommandTemplateParser.Template_objectContext):
        pass

    # Exit a parse tree produced by CommandTemplateParser#template_object.
    def exitTemplate_object(self, ctx:CommandTemplateParser.Template_objectContext):
        pass
